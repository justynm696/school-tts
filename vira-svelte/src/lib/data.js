...
export const schoolData = {
    ...
    campus_guide: [
        ...
        // ── OFFICE ACCOUNTS ──────────────────────────────────────────
        {
            ...
            content: 'The Registrar Office is located on the 1st Floor, near the main entrance. It handles all student enrollment, academic records, transcripts, certificates of enrollment, diplomas, and official document requests. The Registrar also manages subject adding and dropping, as well as transfer credentials. Office Hours: Monday to Friday, 8:00 AM – 5:00 PM; Saturday, 8:00 AM – 12:00 PM. Contact: You may also reach the Registrar through the school\'s main contact number +63 917 114 0297 or email info@clcst.com.ph. For document requests, please allow 3–5 working days for processing.',
            date: '2026-03-21',
            category: 'Office Account',
            priority: 'high',
            icon: '📋'
        },
        {
            id: 'office-canteen',
            title: 'Canteen',
            content: 'The Celtech College Canteen is centrally located on the 1st Floor, providing affordable and nutritious meals, snacks, and beverages for students and faculty throughout the day. The canteen serves Filipino dishes, rice meals, snacks, drinks, and quick bites. Operating Hours: Monday to Friday, 7:00 AM – 6:00 PM; Saturday, 7:00 AM – 3:00 PM. The canteen area also sits near the Kitchen Lab and Function Room. Students can enjoy a comfortable dining space with tables and seating. For bulk orders or catering inquiries related to school events, coordinate with the CTTHM department.',
            date: '2026-03-21',
            category: 'Office Account',
            priority: 'medium',
            icon: '🍽️'
        },
        {
            ...
            content: 'The IT Support Office at Celtech College provides technical assistance for students and faculty across all campuses. Services include: Wi-Fi connectivity support, computer lab assistance, system account management (AIMS Portal), printer and equipment troubleshooting, network issues, and software/hardware concerns. The IT team manages the campus-wide free Wi-Fi system available in all buildings. For AIMS Student Portal access issues, account resets, or system-related concerns, visit or contact the IT Support Office. Office Hours: Monday to Friday, 8:00 AM – 5:00 PM. Located at the Administrative Area, 1st Floor. You can also coordinate with your department secretary for IT referrals.',
            date: '2026-03-21',
            category: 'Office Account',
            priority: 'high',
            icon: '💻'
        },
        {
            ...
            title: 'Accounting / Finance Office',
            content: 'The Accounting and Finance Office is located on the 1st Floor of the main building. It handles all financial transactions including tuition fee payments, miscellaneous fees, installment plans, official receipts, and billing statements. As of January 2026, CELTECH also accepts online payments via Dragonpay — supporting e-wallets, mobile banking, and online banking channels for faster, cashless transactions. Office Hours: Monday to Friday, 8:00 AM – 5:00 PM; Saturday, 8:00 AM – 12:00 PM. For scholarship reimbursements, TES (Tertiary Education Subsidy), or TDP (Tuition Discount Program) queries, the Finance Office coordinates with the CHED-affiliated financial assistance programs. Bring your school ID and billing statement when transacting.',
            date: '2026-03-21',
            category: 'Office Account',
            priority: 'high',
            icon: '💰'
        ...
        {
            id: 'floor-1st',
            title: '1st Floor — Administrative Hub & Facilities',
            content: 'The 1st Floor is the main entry level of Celtech College, housing the most-visited offices and facilities. Key offices: Registrar Office (enrollment, records, transcripts), Finance/Accounting Office (fees, payments, billing), CESO Office, HRS Office, Asset Management Office, OSSAA (Student Affairs), Academics Research Office, Guidance Office, Onboard Training Office, Maritime Faculty Room. Facilities: Canteen, Kitchen Lab, Function Room, Tourism Lab, CTTHM Storage, Clinic (nurse on duty), Chemistry Lab, Food & Beverage Lab, Electrical Lab, SOLAS Lab, Mechanical Area, Refrigeration & Air Conditioning Lab, Faculty Lounge, and Basement access. Main entrance/lobby is on this floor.',
            date: '2026-03-21',
            category: '1st Floor',
            priority: 'high',
            icon: '1️⃣'
        ...
        {
            id: 'floor-2nd',
            title: '2nd Floor — Library, Labs & Classrooms',
            content: 'The 2nd Floor is the academic and learning resource center of the campus. It features: School Library & Information Center (200-seat capacity, 15,000+ books, computers, internet). Specialized Labs: Room 208 – Speech Lab, Room 209 – Computer Lab, Room 211 – Crime Lab (Criminology), Room 212 – Physics Lab. Classrooms: Rooms 201 (Moot Court), 202, 203, 204, 205, 206, 210. The library is open Monday to Friday 7:00 AM–7:00 PM, Saturday 8:00 AM–4:00 PM. Wide corridors with directional arrows and restrooms on both ends.',
            date: '2026-03-21',
            category: '2nd Floor',
            priority: 'high',
            icon: '2️⃣'
        ...
        {
            id: 'floor-3rd',
            title: '3rd Floor — Skills Lab & Technical Classrooms',
            content: 'The 3rd Floor is dedicated to technical and vocational education with focused learning environments. It features the Skills Lab — a hands-on training facility with tools and equipment for technical disciplines. Classrooms (Upper Row): Rooms 310, 311, 312, 313, 314, 315, 316. Classrooms (Lower Row): Rooms 301, 302, 303, 304, 305, 306, 307. All rooms are equipped with projectors, whiteboards, and comfortable seating. Restrooms and stairs are at both ends of the floor. Ideal for engineering, industrial technology, and vocational programs.',
            date: '2026-03-21',
            category: '3rd Floor',
            priority: 'medium',
            icon: '3️⃣'
        ...
        {
            id: 'floor-4th',
            title: '4th Floor — Auditorium & Maritime Training',
            content: 'The 4th Floor is home to the MOLA Auditorium — a large multipurpose hall with hundreds of seats, modern AV equipment, and air conditioning used for assemblies, seminars, graduations, and cultural events. Maritime Training Facilities: Room 406 – Mock Bridge (ship bridge simulations), Room 404 – Plotting Room (navigation & chart work), Room 412 – GMDSS Room (Global Maritime Distress & Safety System), Engineering Simulator, Bridge Simulator. Classrooms: Rooms 405, 408, 409, 410, 411. The 4th floor is the heart of maritime education and large campus events.',
            date: '2026-03-21',
            category: '4th Floor',
            priority: 'high',
            icon: '4️⃣'
